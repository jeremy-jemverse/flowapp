...
// Card Tabs variant
const CardTabs = React.forwardRef<
...
// Toolbar Tabs variant
const ToolbarTabs = React.forwardRef<
  React.ElementRef<typeof TabsPrimitive.Root>,
  React.ComponentPropsWithoutRef<typeof TabsPrimitive.Root>
>(({ className, ...props }, ref) => (
  <Tabs
...
ToolbarTabs.displayName = 'ToolbarTabs';

const ToolbarTabsList = React.forwardRef<
  React.ElementRef<typeof TabsPrimitive.List>,
  React.ComponentPropsWithoutRef<typeof TabsPrimitive.List>
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
...
ToolbarTabsList.displayName = 'ToolbarTabsList';

const ToolbarTabsTrigger = React.forwardRef<
  React.ElementRef<typeof TabsPrimitive.Trigger>,
  React.ComponentPropsWithoutRef<typeof TabsPrimitive.Trigger>
>(({ className, ...props }, ref) => (
  <TabsPrimitive.Trigger
...
ToolbarTabsTrigger.displayName = 'ToolbarTabsTrigger';
